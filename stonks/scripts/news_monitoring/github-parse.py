...
os.chdir('C:/Users/roman/PycharmProject/')
...
def main():
    ...
    for i in range(len(output)):
        if 'https://' not in output['link'][i] and output['link'][i] is not "":
            print(type(output['link'][i]))
            print(i)
